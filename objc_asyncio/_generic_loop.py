...
from . import _selector as selectors
from . import _transports as transports
from . import _trsock as trsock
...
class GenericLoop(asyncio.BaseEventLoop):
    # The methods below were copied verbatim from
    # the stdlib implementation of asyncio.
    #
    # The SOURCE markers help in updating.
    #

    # SOURCE: unix_events.py
